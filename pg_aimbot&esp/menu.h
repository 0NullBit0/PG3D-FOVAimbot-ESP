        ...
        for (int i = 0; i < enemylistESP.size(); i++) {
            ...
            if (enemylistESP[i].enemy) {
                ESP::DrawLine(ImVec2((float) glWidth / 2, 0.0f),
                                ImVec2((float) glWidth - (glWidth - enemylistESP[i].pos.X),
                                        ((float) glHeight - enemylistESP[i].pos.Y - 10.0f)),
                                ImVec4(1.0f, 0.0f, 0.0f, 1.0f), 3.0f);
                
            } else {
                ESP::DrawLine(ImVec2((float) glWidth / 2, 0.0f),
                                ImVec2((float) glWidth - (glWidth - enemies[i].pos.X),
                                        ((float) glHeight - enemies[i].pos.Y - 10.0f)),
